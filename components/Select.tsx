      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className='relative'>
          ...
          <Transition
            ...
            leaveTo='opacity-0'>
            <Listbox.Options className='absolute rounded z-50 max-h-60 w-full overflow-auto bg-white py-1 text-sm shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none capitalize'>
