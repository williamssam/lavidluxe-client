...
export const Tabs = () => {
  ...
  return (
    <ul className='mt-14 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-[0.7rem] font-semibold uppercase tracking-widest md:tracking-[3px] text-[#999999] md:mt-10 md:text-[0.69rem] lg:gap-16'>
      {tabs?.map(tab => (
        <li key={tab.id}>
          <Link
            href={tab.href}
