...
const Details = () => {
  return (
    <>
      <Head>
        <title>Lavidluxe - Details</title>
      </Head>

      <main className="flex min-h-screen flex-col items-center  md:grid md:grid-cols-5">
        {/* <img
          src={hero}
          alt=""
        /> */}
        ...
        <section className="justify-end self-center px-3 py-5 md:col-span-2 md:px-16 md:pb-0">
          ...
          <header className="text-center md:pt-2 md:text-left">
            <h2 className="text-base font-black uppercase tracking-[3px] text-gray-600 md:text-2xl md:tracking-[6px]">
              The skinny in stone ponya
            </h2>
            <p className="pt-2 text-sm font-bold text-gray-500 md:text-base">
              $ 175.00
            </p>
          </header>

          <div className="max-w-[55ch] py-10 text-center font-vollkorn text-sm leading-7 md:text-left md:text-base">
          ...
          <footer className="mt-10">
            ...
            {/* share product */}
            <div className="mt-8 flex items-center justify-center gap-2 text-xs md:justify-end">
